...
Route::get('/user/createReservation', 'ReservationController@userCreate' );
Route::get('/user/editReservation', 'ReservationController@userEdit' );
Route::get('/user/listReservations', 'ReservationController@userIndex' );
