			...
			<v-col cols="12" sm="10" md="8" lg="5" xl="4">
				<v-card class="transparent_form">
					<v-card-text class="boksik">
						...
						<v-row class="justify-center">
							<v-btn @click="getAvailableTables(date)" v-bind:loading="searchLoading" :disabled="date == null"
						...
						<v-card class="transparent_form">
							...
							<v-card-text class="boksik">
								<v-form>
									...
									<v-row class="justify-center">
										<v-btn @click="saveReservation" v-bind:loading="reservationLoading" class="yellow_form_button"
													 color="secondary">
											Zarezerwuj
										</v-btn>
									</v-row>
